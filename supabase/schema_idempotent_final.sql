...
DROP TRIGGER IF EXISTS update_work_settings_updated_at ON public.work_settings;
...
DROP TRIGGER IF EXISTS update_investment_assets_updated_at ON public.investment_assets;
