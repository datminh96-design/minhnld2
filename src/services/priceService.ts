...
export const POPULAR_PRESET_ASSETS: PresetAssetItem[] = [
  ...
  // HOSE / HNX Stocks
  { symbol: 'TPB', name: 'Ngân hàng Tiên Phong (TPBank)', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'VCB', name: 'Ngân hàng Ngoại Thương (Vietcombank)', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'HPG', name: 'Tập đoàn Hòa Phát', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'FPT', name: 'Tập đoàn FPT', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'MWG', name: 'Thế Giới Di Động', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'SSI', name: 'Chứng khoán SSI', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'TCB', name: 'Ngân hàng Techcombank', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'MBB', name: 'Ngân hàng Quân Đội (MBBank)', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'VHM', name: 'CTCP Vinhomes', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'VIC', name: 'Tập đoàn Vingroup', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'STB', name: 'Ngân hàng Sacombank', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'DGC', name: 'Hóa chất Đức Giang', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'CTG', name: 'Ngân hàng VietinBank', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },
  { symbol: 'ACB', name: 'Ngân hàng Á Châu', type: 'Cổ phiếu', category: 'stock', exchange: 'HOSE' },

  // Mutual Funds
  { symbol: 'VEOF', name: 'Quỹ Cổ phiếu VinaCapital (VEOF)', type: 'Quỹ', category: 'fund', exchange: 'VinaCapital' },
  { symbol: 'VESAF', name: 'Quỹ Tiếp cận Thị trường (VESAF)', type: 'Quỹ', category: 'fund', exchange: 'VinaCapital' },
  { symbol: 'DCDS', name: 'Quỹ Tăng trưởng Dragon Capital (DCDS)', type: 'Quỹ', category: 'fund', exchange: 'Dragon Capital' },
  { symbol: 'DCBC', name: 'Quỹ Cân bằng Dragon Capital (DCBC)', type: 'Quỹ', category: 'fund', exchange: 'Dragon Capital' },

  // Gold
  { symbol: 'SJC', name: 'Vàng miếng SJC 9999 (1 lượng)', type: 'Vàng', category: 'gold', exchange: 'SJC 9999' },
...
export const KNOWN_ASSET_NAMES: Record<string, { name: string; type: AssetType; exchange: string }> = {
  ...
  // Vietnam Stocks
  TPB: { name: 'Ngân hàng Tiên Phong (TPBank)', type: 'Cổ phiếu', exchange: 'HOSE' },
  VCB: { name: 'Ngân hàng Ngoại Thương (Vietcombank)', type: 'Cổ phiếu', exchange: 'HOSE' },
  HPG: { name: 'Tập đoàn Hòa Phát', type: 'Cổ phiếu', exchange: 'HOSE' },
  FPT: { name: 'Tập đoàn FPT', type: 'Cổ phiếu', exchange: 'HOSE' },
  MWG: { name: 'Thế Giới Di Động', type: 'Cổ phiếu', exchange: 'HOSE' },
  SSI: { name: 'Chứng khoán SSI', type: 'Cổ phiếu', exchange: 'HOSE' },
  TCB: { name: 'Ngân hàng Techcombank', type: 'Cổ phiếu', exchange: 'HOSE' },
  MBB: { name: 'Ngân hàng Quân Đội (MBBank)', type: 'Cổ phiếu', exchange: 'HOSE' },
  VHM: { name: 'CTCP Vinhomes', type: 'Cổ phiếu', exchange: 'HOSE' },
  VIC: { name: 'Tập đoàn Vingroup', type: 'Cổ phiếu', exchange: 'HOSE' },
  STB: { name: 'Ngân hàng Sacombank', type: 'Cổ phiếu', exchange: 'HOSE' },
  DGC: { name: 'Hóa chất Đức Giang', type: 'Cổ phiếu', exchange: 'HOSE' },
  CTG: { name: 'Ngân hàng VietinBank', type: 'Cổ phiếu', exchange: 'HOSE' },
  ACB: { name: 'Ngân hàng Á Châu', type: 'Cổ phiếu', exchange: 'HOSE' },
  VPB: { name: 'Ngân hàng VPBank', type: 'Cổ phiếu', exchange: 'HOSE' },
  HDB: { name: 'Ngân hàng HDBank', type: 'Cổ phiếu', exchange: 'HOSE' },
  VND: { name: 'Chứng khoán VNDirect', type: 'Cổ phiếu', exchange: 'HOSE' },
  GEX: { name: 'Tập đoàn GELEX', type: 'Cổ phiếu', exchange: 'HOSE' },
  VRE: { name: 'Vincom Retail', type: 'Cổ phiếu', exchange: 'HOSE' },
  GAS: { name: 'PV Gas', type: 'Cổ phiếu', exchange: 'HOSE' },
  MSN: { name: 'Tập đoàn Masan', type: 'Cổ phiếu', exchange: 'HOSE' },
  PLX: { name: 'Tập đoàn Petrolimex', type: 'Cổ phiếu', exchange: 'HOSE' },
  PNJ: { name: 'Vàng Bạc Đá Quý Phú Nhuận', type: 'Cổ phiếu', exchange: 'HOSE' },
  VNM: { name: 'Vinamilk', type: 'Cổ phiếu', exchange: 'HOSE' },
  KDH: { name: 'Nhà Khang Điền', type: 'Cổ phiếu', exchange: 'HOSE' },
  PDR: { name: 'Bất động sản Phát Đạt', type: 'Cổ phiếu', exchange: 'HOSE' },
  NVL: { name: 'Tập đoàn Novaland', type: 'Cổ phiếu', exchange: 'HOSE' },
  DIG: { name: 'Tổng CTCP DIC Corp', type: 'Cổ phiếu', exchange: 'HOSE' },

  // Funds
  VEOF: { name: 'Quỹ Cổ phiếu VinaCapital (VEOF)', type: 'Quỹ', exchange: 'VinaCapital' },
  VESAF: { name: 'Quỹ Tiếp cận Thị trường (VESAF)', type: 'Quỹ', exchange: 'VinaCapital' },
  DCDS: { name: 'Quỹ Tăng trưởng Dragon Capital (DCDS)', type: 'Quỹ', exchange: 'Dragon Capital' },
  DCBC: { name: 'Quỹ Cân bằng Dragon Capital (DCBC)', type: 'Quỹ', exchange: 'Dragon Capital' },
  VIBF: { name: 'Quỹ Đầu tư Cân bằng VinaCapital', type: 'Quỹ', exchange: 'VinaCapital' },
  SSISCA: { name: 'Quỹ Đầu tư Cổ phiếu SSI', type: 'Quỹ', exchange: 'SSI Asset' },

  // Gold
  SJC: { name: 'Vàng miếng SJC 9999 (1 lượng)', type: 'Vàng', exchange: 'SJC 9999' },
};
